...
describe "when dealing with backstage passes" do
  ...
  it "increases in quality by 1 when 11 days or more of sell_in value left" do
    backstage_pass = [Pass.new("Backstage passes to a TAFKAL80ETC concert", 11, 10)]
